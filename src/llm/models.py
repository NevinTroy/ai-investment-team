...
def get_model(
    ...
    if model_provider == ModelProvider.GROQ:
        ...
        return ChatGroq(model=model_name, api_key=api_key, max_tokens=max_tokens) if max_tokens else ChatGroq(model=model_name, api_key=api_key)
        ...
        openai_kwargs: dict = {"model": model_name, "api_key": api_key, "base_url": base_url}
        ...
        anthropic_kwargs: dict = {"model": model_name, "api_key": api_key}
        if max_tokens is not None:
